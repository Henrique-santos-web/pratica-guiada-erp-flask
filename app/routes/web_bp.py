...
def listar_produtos_view():
    ...
    return render_template("produtos/listar.html", produtos=produtos) #* vfai até a pasta produtos, vai até a pasta listar.html e recebe a variável, pelo jinja2, chamada produtos 
